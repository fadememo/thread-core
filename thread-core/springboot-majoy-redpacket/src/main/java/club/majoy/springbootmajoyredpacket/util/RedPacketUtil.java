...
public class RedPacketUtil {
    ...
    public static final String CONSUMED_RED_PACKET_LIST = "CONSUMED_RED_PACKET_LIST";
    public static final String CONSUMED_RED_PACKET_MAP = "CONSUMED_RED_PACKET_MAP";
